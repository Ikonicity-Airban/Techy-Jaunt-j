    ...
    return (
        <main className="bg-[whitesmoke] min-h-screen w-full" style={{
            ...
            <div className="max-w-xl mx-auto min-h-[90vh] flex flex-col">
                ...
                <header className="p-4 backdrop-hue-rotate-15 flex flex-col items-center justify-between border-b-[1px] shadow-sm rounded-b-3xl">
                    <div className="my-4">
                        <Logo />
                    </div>
                    <nav className="w-full mt-10 px-2">
                        <div className="w-full flex gap-4 group transition-shadow duration-150" >
                            <NavLink to="/login" replace
                                className={({ isActive }) => isActive ? "text-green-500 btn-neu-bevel w-full" : "btn-neu-pop w-full bg-green-500 text-light text-base"}>
                                Login
                            </NavLink>
